...
from Yukinon import *
from Yukinon.utils.filter_groups import *
from lang import get_command
from Yukinon.utils.lang import *
from Yukinon.utils.commands import *
from Yukinon import *
from Yukinon.mongo import chatb
from Yukinon.plugins.antlangs import get_arg
from Yukinon.utils.custom_filters import admin_filter
from button import *
...
async def szcbot(_, message: Message):
    ...
    if chat:
       ...
       affiliateplus = requests.get(f"https://api.affiliateplus.xyz/api/chatbot?message={text}&botname=Yukinon&ownername=@supunma&user=1")
       textmsg = (affiliateplus.json()["message"])
       if "Affiliate+" in textmsg:
        textmsg = textmsg.replace("Affiliate+", "Yukinon bot created by @szteambots")
...
AI based chatbot allows Yukinon to talk and provides a more interactive group chat experience.
...
**Language Support**
Yukinon AI chatbot support almost all languages in world .
