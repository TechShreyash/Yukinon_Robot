...
from Yukinon.mongo.language import *
    ...
    [
        ...
        [
            InlineKeyboardButton(
                ...
                url=f"https://crwd.in/szYukinonbot",
            )
        ],
        [
            InlineKeyboardButton(
...
async def language_markup(_, CallbackQuery):
    ...
    return await CallbackQuery.message.edit("[🌎](https://crwd.in/szYukinonbot)Language was changed Successfully \n.Changed by {}".format(user),
        reply_markup=keyboard,
...
__HELP__ = """
Not every group speaks fluent english; some groups would rather have Yukinon respond in their own language.
