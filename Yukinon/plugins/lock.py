...
from Yukinon.plugins.protection import *
from Yukinon.mongo.approvedb import Approve 
from Yukinon.mongo.locksdb import *
from Yukinon import *
from Yukinon import BOT_ID, app as pbot, MONGO_URL as  MONGO_DB_URI
