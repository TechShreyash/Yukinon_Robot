...
from Yukinon import *
from Yukinon.mongo.gban import GBan
...
from Yukinon.mongo.feddb import (get_fed_from_chat,
...
my news channel @TheszYukinonbot.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/szYukinonbot?start=help"),
            ]))
