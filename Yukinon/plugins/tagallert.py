...
from Yukinon.mongo import taggeddb
from button import *
...
async def mentioned_alert(client, message):   
    try:
        ...
        if "@" in input_str:
            ...
            Yukinon = input_str.split("|")[1]
            text = Yukinon.split()[0]
...
If you are tagged/mentioned in a group where Yukinon is present
Yukinon will notify it to you via private message after enabling tag alerts
...
**Example:**
If you are mentioned in a group Yukinon will tell you who mentioned you, 
