...
from Yukinon.mongo.reportdb import Reporting
...
Yukinon will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. Yukinon assumes that admins 
