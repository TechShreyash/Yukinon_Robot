...
from Yukinon.mongo.notesdb import Notes, NotesSettings
from Yukinon.utils.cmd_senders import send_cmd
from Yukinon.utils.custom_filters import admin_filter, command, owner_filter
from Yukinon.utils.kbhelpers import rkb as ikb
from Yukinon.utils.msg_types import Types, get_note_type
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/szYukinonbot?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
        ...
        pm_kb = ikb(
            [
                [
                    (
                        "All Notes",
                        f"https://t.me/szYukinonbot?start=notes_{grp_id}",
                        "url",
                    ),
                ],
            ],
