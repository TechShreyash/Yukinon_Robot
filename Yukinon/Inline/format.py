...
Yukinon supports a large number of formatting 
...
Alternatively, check out <a href='http://www.supun.ml/Yukinon.html'>This Web site</a> to generate the button syntax for yoctx.

- [note button](buttonurl://#notename): This syntax will allow you to 
create a button which links to a note. When clicked, 
the user will be redirected to Yukinon's PM to see the note.
"""
...
This will randomly choose between sending the first message, "hello", or the second message, "how are you".
 Use this to make Yukinon feel a bit more customised! (only works in notes/filters/greetings)
